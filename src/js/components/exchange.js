...
function ExchangeViewModel() {
  ...
  self.sell = function() {
    ...
    message += '<tr><td><b>' + i18n.t('fee') + ': </b></td><td style="text-align:right">' + self.sellFeeController.getFeeInGasp() + '</td><td>GASP ($'+self.sellFeeController.getFeeInFiat()+' USD)</td></tr>';
    message += '</table>';
  ...
  self.buy = function() {
    ...
    message += '<tr><td><b>' + i18n.t('real_estimated_total') + ': </b></td><td style="text-align:right">' + estimatedTotalPrice + '</td><td>' + self.dispQuoteAsset() + '</td></tr>';
    message += '<tr><td><b>' + i18n.t('fee') + ': </b></td><td style="text-align:right">' + self.buyFeeController.getFeeInGasp() + '</td><td>GASP ($'+self.buyFeeController.getFeeInFiat()+' USD)</td></tr>';
    message += '</table>';
